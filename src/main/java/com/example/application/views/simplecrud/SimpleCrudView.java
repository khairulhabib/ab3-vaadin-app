package com.example.application.views.simplecrud;
...
@PageTitle("SimpleCrud")
@Route(value = "hello/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Uses(Icon.class)
public class SimpleCrudView extends Div implements BeforeEnterObserver {
    ...
    @Autowired
    public SimpleCrudView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("simple-crud-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(SimpleCrudView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(SimpleCrudView.class);
            }
        }
    }
